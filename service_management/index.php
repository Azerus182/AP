...
require_once($_SERVER["DOCUMENT_ROOT"]."/_View/ServiceManagement.php");
...
if ($user == null || $role["edit_services"] == false) {
...
<head>
    ...
    <script src="/assets/js/serviceManagement.js"></script>
</head>
<body>
<?php
    echo(
        ...
        .($role["edit_services"] ? new ServiceManagement($services->listServices()) : "")
    );
?>
</body>
</html>
